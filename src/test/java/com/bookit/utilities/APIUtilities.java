...
// This class consist of Api operations on endpoints
...
public class APIUtilities {
     ...
     * If user exists - this method will that user.r
     * @param email
     * @param password
     */
    public static void ensureUserDoesntExist(String email, String password) {
        ...
        // we can use this method in the tests before adding the user
        // we just wanna make sure user is not exits at all ! !
        // condition is true if userId has positive value
        if (userID > 0) {
